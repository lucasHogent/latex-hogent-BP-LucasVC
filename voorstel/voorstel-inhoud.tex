...
Een van die magazijnen dat hier in deze paper in aanmerking komt is de oudste binnen TVH. 
...
De server dat instaat voor de communicatie tussen WMS en PLC voor het oudste automatisch magazijn wordt niet ondersteund.
...
\begin{enumerate}
  \item Overzicht messaging systemen
  \item Synchrone en asynchrone communicatie. 
...
\begin{figure}[htbp]
  ...
  \ytl{Okt, 1 dag}{Long list}
  \ytl{Nov, 2 dagen}{Opstellen testscenario's}
