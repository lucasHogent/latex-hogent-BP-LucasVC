...
% \subsection{Plot ActiveMQ}\label{sec:plot_amq}
% \inputminted{python3}{../plot/amq/amq_messages_received_plot.ipynb}
% \captionof{listing}{\label{listing:plot_amq}Plot for ActiveMQ Classic test.}
...
% \subsection{Plot RabbitMQ}\label{sec:plot_rabbitmq}
% \inputminted{json}{../plot/rabbitmq/rabbitmq_messages_received_plot.ipynb}
% \captionof{listing}{\label{listing:plot_rabbitmq}Plot for RabbitMQ test.}
...
% \subsection{Plot Artemis}\label{sec:plot_artemis}
% \inputminted{python3}{../plot/artemis/artemis_messages_received_plot.ipynb}
% \captionof{listing}{\label{listing:plot_artemis}Plot for Artemis test.}
